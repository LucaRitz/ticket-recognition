...
cmake -G"$CMAKE_CONFIG_GENERATOR" -DCMAKE_INSTALL_PREFIX="$myRepo"/build -DPROJECT_BINARY_DIR="$myRepo"/build -DLINUX_BUILD=true -DCMAKE_PROJECT_NAME="ticket_recognition" "$myRepo/sources"
