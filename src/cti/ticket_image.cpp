...
cti::TicketImage::TicketImage(const int width, const int height, const int bytes_per_pixel, const size_t bytes_per_line,
                              unsigned char *image)
...
const size_t cti::TicketImage::bytesPerLine() const {
