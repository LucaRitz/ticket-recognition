...
#----------------------------------------------------------
    ...
    if(EXISTS "${OpenCV_DIR}")
        ...
        if(EXISTS "${OpenCV_DIR}/windows/OpenCVConfig.cmake")

            ## Include the standard CMake script
            include("${OpenCV_DIR}/windows/OpenCVConfig.cmake")

            ## Search for a specific version
            set(CVLIB_SUFFIX "${OpenCV_VERSION_MAJOR}${OpenCV_VERSION_MINOR}${OpenCV_VERSION_PATCH}")

            #Otherwise it try to guess it.
        else(EXISTS "${OpenCV_DIR}/windows/OpenCVConfig.cmake")

            set(OPENCV_LIB_COMPONENTS cxcore cv ml highgui cvaux)
            set(OpenCV_INCLUDE_DIR "${OpenCV_DIR}/windows/include/opencv2")
        ...
        endif(EXISTS "${OpenCV_DIR}/windows/OpenCVConfig.cmake")
